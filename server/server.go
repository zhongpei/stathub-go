...
func DonwloadClient64Handler(w http.ResponseWriter, r *http.Request) {

	http.ServeFile(w, r, SERVER_WORKDIR+CLIENT_FILE+"_x86_64.tar.gz")
}

func DonwloadClient32Handler(w http.ResponseWriter, r *http.Request) {
...
func main() {
	...
	http.HandleFunc("/download/client_x86_64.tar.gz", DonwloadClient64Handler)
